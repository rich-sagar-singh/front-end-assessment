...
export default function Filters({
  ...
  const debouncedSetZipCode = useCallback(debounce(setZipCode, 500), []);
  const debouncedSetAgeMin = useCallback(debounce(setAgeMin, 500), []);
  const debouncedSetAgeMax = useCallback(debounce(setAgeMax, 500), []);
